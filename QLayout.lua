...
local groups = {
  [ChatFrame1] = {"SYSTEM", "SYSTEM_NOMENU", "SAY", "EMOTE", "CHANNEL", "MONSTER_SAY", "MONSTER_YELL", "MONSTER_EMOTE", "MONSTER_WHISPER", "MONSTER_BOSS_EMOTE", "MONSTER_BOSS_WHISPER", "ERRORS", "ACHIEVEMENT", "TRADE"},
	[ChatFrame2] = {},
  [ChatFrame3] = {"GUILD", "OFFICER", "GUILD_ACHIEVEMENT"},
  [ChatFrame4] = {"BN_WHISPER", "BN_CONVERSATION", "WHISPER", "AFK", "DND", "IGNORED", "PARTY", "PARTY_LEADER", "RAID_WARNING", "RAID", "RAID_LEADER", "BG_HORDE", "BG_ALLIANCE", "BG_NEUTRAL", "BATTLEGROUND", "BATTLEGROUND_LEADER", "INSTANCE_CHAT", "INSTANCE_CHAT_LEADER"},

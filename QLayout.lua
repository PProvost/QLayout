...
local groups = {
  ...
  [ChatFrame4] = {"BN_WHISPER", "BN_CONVERSATION", "WHISPER", "AFK", "DND", "IGNORED", "PARTY", "PARTY_LEADER", "RAID_WARNING", "RAID", "RAID_LEADER", "BG_HORDE", "BG_ALLIANCE", "BG_NEUTRAL", "BATTLEGROUND", "BATTLEGROUND_LEADER"},
